...
const app = {
    ...
    translations: {
        en: {
            ...
            p_type: "Product Type",
            type_resale: "Resale",
            type_manufactured: "Self-Manufactured",
        ...
        si: {
            ...
            // New Keys
            p_type: "භාණ්ඩයේ වර්ගය",
            type_resale: "නැවත විකුණන (Resale)",
            type_manufactured: "නිෂ්පාදනය කරන (Manufactured)",
            low_stock_only: "අඩුවී ඇති තොග පමණි",
            all_items: "සියලුම භාණ්ඩ",
            no_results: "ප්‍රතිඵල හමු නොවීය.",
            confirm_title: "ඔබට විශ්වාසද?",
            confirm_delete_msg: "මෙය මැකූ පසු නැවත ලබා ගත නොහැක.",
            confirm_void_msg: "මෙම බිල්පත අවලංගු කර තොග යාවත්කාලීන කරනු ඇත. ඉදිරියට යන්නද?"
        }
    ...
    init: async () => {
        ...
        if (count === 0) {
            await db.products.bulkAdd([
                { name: 'Cement Bag (50kg)', category: 'Construction', wholesalePrice: 1800, retailPrice: 2000, stockCount: 50, unit: 'bag', code: 'CEM001', type: 'resale' },
                { name: 'Sand (Cube)', category: 'Construction', wholesalePrice: 12000, retailPrice: 14000, stockCount: 10, unit: 'cube', code: 'SND001', type: 'resale' },
                { name: 'Paint (White, 4L)', category: 'Paint', wholesalePrice: 4500, retailPrice: 5200, stockCount: 20, unit: 'can', code: 'PNT001', type: 'resale' },
                { name: 'Hammer (Steel)', category: 'Tools', wholesalePrice: 800, retailPrice: 1200, stockCount: 15, unit: 'pcs', code: 'TOL001', type: 'resale' },
                { name: 'Concrete Block (4x8x16)', category: 'Construction', wholesalePrice: 120, retailPrice: 150, stockCount: 500, unit: 'pcs', code: 'BLK001', type: 'manufactured' },
            ]);
        }
