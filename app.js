...
db.version(1).stores({
    products: '++id, name, category, wholesalePrice, retailPrice, stockCount, unit, code',
...
const app = {
    ...
    translations: {
        en: {
            ...
            search_inventory_placeholder: "Search products...",
            th_code: "Code",
            th_name: "Name",
            th_category: "Category",
            th_stock: "Stock",
            th_wholesale: "Wholesale",
            th_retail: "Retail",
            th_actions: "Actions",
            ...
            // History
            history_title: "Bill Management",
            search_bill_placeholder: "Search Bill Number...",
            th_bill_no: "Bill #",
            th_date: "Date",
            th_amount: "Amount",
            th_payment: "Payment",
            ...
            logo_upload: "Shop Logo (Optional)",
            ...
            toast_backup_success: "Backup Downloaded!",
            toast_restore_success: "Data Restored Successfully!",
            err_restore_failed: "Error restoring data!",
            toast_bill_deleted: "Bill #{0} Deleted",
            toast_bill_loaded: "Bill #{0} loaded for editing",
            confirm_delete_bill_msg: "Are you sure you want to delete Bill #{0}? This will restore stock and reverse credit.",
            confirm_edit_bill_msg: "To edit Bill #{0}, it must be deleted and items loaded back to the POS. Proceed?",
        ...
        si: {
            ...
            // Dashboard
            dashboard_title: "මුල් පිටුව",
            total_revenue: "අද දින ආදායම",
            low_stock_alerts: "අඩු වී ඇති තොග",
            total_products: "මුළු භාණ්ඩ ගණන",
            recent_transactions: "මෑත ගනුදෙනු",
            no_sales_today: "අද දින විකුණුම් නොමැත.",

            // POS
            pos_title: "විකුණුම් බිල්පත",
            search_product_placeholder: "භාණ්ඩයේ නම හෝ අංකය සොයන්න...",
            cart_subtotal: "එකතුව",
            cart_discount: "වට්ටම් (රු)",
            cart_customer: "පාරිභෝගිකයා",
            cart_payment: "ගෙවන ක්‍රමය",
            cart_total: "මුළු මුදල",
            checkout_btn: "බිල්පත මුද්‍රණය කරන්න",
            cart_empty: "බඩු තෝරාගෙන නැත",
            walk_in_customer: "සාමාන්‍ය පාරිභෝගිකයෙක්",

            // Inventory
            inventory_title: "තොග කළමනාකරණය",
            add_product: "නව භාණ්ඩයක්",
            search_inventory_placeholder: "භාණ්ඩ සොයන්න...",
            th_code: "කේතය",
            th_name: "නම",
            th_category: "වර්ගය",
            th_stock: "තොග",
            th_wholesale: "තොග මිල",
            th_retail: "සිල්ලර මිල",
            th_actions: "ක්‍රියා",
            no_products: "භාණ්ඩ හමු නොවීය",

            // Customers
            customer_title: "පාරිභෝගික කළමනාකරණය",
            add_customer: "නව පාරිභෝගිකයෙක්",
            th_phone: "දුරකථන",
            th_credit: "ණය මුදල",

            // Suppliers
            supplier_title: "සැපයුම්කරුවන්",
            add_supplier: "නව සැපයුම්කරුවෙක්",
            th_contact: "විස්තර",

            // History
            history_title: "පැරණි බිල්පත්",
            search_bill_placeholder: "බිල් අංකය සොයන්න...",
            th_bill_no: "බිල් අංකය",
            th_date: "දිනය",
            th_amount: "වටිනාකම",
            th_payment: "ගෙවීම",
            ...
            shop_name: "වෙළඳසැලේ නම",
            address: "ලිපිනය",
            phone_number: "දුරකථන අංකය",
            header_msg: "බිල්පතේ ඉහල පණිවිඩය",
            footer_msg: "බිල්පතේ පහල පණිවිඩය",
            logo_upload: "වෙළඳසැලේ ලෝගෝව (Optional)",
            save_config: "සැකසුම් සුරකින්න",
            receipt_preview: "බිල්පතේ පෙනුම",

            // Modals
            add_new_product: "නව භාණ්ඩයක් එක් කරන්න",
            ...
            confirm_delete_bill: "ඔබට මෙම බිල්පත මැකීමට අවශ්‍යද?",
            sale_completed: "විකිණීම සාර්ථකයි!",
            product_saved: "භාණ්ඩය සුරැකින ලදී!",
            p_code: "භාණ්ඩ කේතය (Code)",
            p_name: "භාණ්ඩයේ නම",
            p_unit: "මිනුම (Unit)",
            ...
            // Errors & Toasts
            err_cart_empty: "කූඩය හිස්ය!",
            err_select_cust_credit: "ණයට විකිණීම සඳහා කරුණාකර පාරිභෝගිකයෙකු තෝරන්න!",
            toast_cust_added: "පාරිභෝගිකයා එකතු කරන ලදී!",
            toast_supp_added: "සැපයුම්කරු එකතු කරන ලදී!",
            toast_config_saved: "සකසුම් සුරැකින ලදී!",
            toast_backup_success: "Backup ගොනුව බාගත කරන ලදී!",
            toast_restore_success: "දත්ත නැවත පිහිටුවීම සාර්ථකයි!",
            err_restore_failed: "දත්ත නැවත පිහිටුවීම අසාර්ථකයි!",
            toast_bill_deleted: "බිල් අංක #{0} මකන ලදී",
            toast_bill_loaded: "බිල් අංක #{0} සංස්කරණය සඳහා ගන්නා ලදී",
            confirm_delete_bill_msg: "ඔබට බිල් අංක #{0} මැකීමට අවශ්‍යද? මෙය තොග නැවත යාවත්කාලීන කරන අතර ණය ශේෂය වෙනස් කරනු ඇත.",
            confirm_edit_bill_msg: "බිල් අංක #{0} සංස්කරණය කිරීමට, එය මැකිය යුතු අතර භාණ්ඩ නැවත POS වෙත පැමිණේ. ඉදිරියට යන්නද?",

            // Receipt
            receipt_invoice: "බිල් අංකය",
            receipt_date: "දිනය",
            receipt_cust: "පාරිභෝගික",
            receipt_item: "භාණ්ඩය",
            receipt_qty: "ප්‍රම",
            receipt_amt: "වටිනාකම",
            receipt_discount: "වට්ටම්",
    ...
    toggleTheme: () => {
        ...
        if (settingsBtn) {
            if (isLight) {
                // Currently Light Mode -> Show Dark Icon
                settingsBtn.innerHTML = `<i data-lucide="moon" class="w-5 h-5"></i>`;
                settingsBtn.className = "p-2 rounded-full bg-slate-200 text-slate-800 shadow-md hover:scale-110 transition-all";
            } else {
                // Currently Dark Mode -> Show Light Icon
                settingsBtn.innerHTML = `<i data-lucide="sun" class="w-5 h-5"></i>`;
                settingsBtn.className = "p-2 rounded-full bg-slate-800 text-yellow-400 border border-slate-700 hover:scale-110 transition-all";
            }
        }
        lucide.createIcons();
    },
    ...
    updateThemeUI: () => {
        ...
        if (btn) {
            if (isLight) {
                ...
                btn.className = "absolute top-6 right-6 z-50 p-2 rounded-full bg-white text-slate-800 shadow-lg border border-slate-200 hover:bg-slate-100 transition-all";
            } else {
                btn.innerHTML = `<i data-lucide="sun" class="w-5 h-5"></i>`;
                btn.className = "absolute top-6 right-6 z-50 p-2 rounded-full bg-slate-800 text-yellow-400 shadow-lg border border-slate-700 hover:bg-slate-700 transition-all";
            }
        }
        lucide.createIcons();
    },
    ...
    init: async () => {
        ...
        if (count === 0) {
            await db.products.bulkAdd([
                { name: 'Cement Bag (50kg)', category: 'Construction', wholesalePrice: 1800, retailPrice: 2000, stockCount: 50, unit: 'bag', code: 'CEM001' },
                { name: 'Sand (Cube)', category: 'Construction', wholesalePrice: 12000, retailPrice: 14000, stockCount: 10, unit: 'cube', code: 'SND001' },
                { name: 'Paint (White, 4L)', category: 'Paint', wholesalePrice: 4500, retailPrice: 5200, stockCount: 20, unit: 'can', code: 'PNT001' },
                { name: 'Hammer (Steel)', category: 'Tools', wholesalePrice: 800, retailPrice: 1200, stockCount: 15, unit: 'pcs', code: 'TOL001' },
            ]);
        }
    ...
    navigate: (view) => {
        ...
        // Update Active Nav
        // Update Active Nav
        document.querySelectorAll('.nav-item').forEach(el => el.classList.remove('active', 'bg-slate-700/50', 'text-white'));
        const activeNav = document.getElementById(`nav-${view}`);
        if (activeNav) activeNav.classList.add('active', 'bg-slate-700/50', 'text-white');

        // Update Language UI Toggle State
        app.updateLanguageUI();
        app.updateThemeUI();
        ...
        setTimeout(async () => {
            ...
            lucide.createIcons();
        }, 50); // Small delay for UI responsivenes
    },
                ...
                if (ctx) {
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Revenue (LKR)',
                                data: [12000, 19000, 3000, 5000, 2000, 30000, totalRevenue], // Mock data + today
                                borderColor: '#6366f1',
            ...
            container.innerHTML = `
                <div class="p-4 md:p-8 fade-in h-full flex flex-col">
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                        <h2 class="text-2xl font-bold text-white">${app.t('inventory_title')}</h2>
                        <div class="flex items-center gap-4">
                            ...
                            <button onclick="app.handlers.openProductModal()" class="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
                                <i data-lucide="plus" class="w-4 h-4"></i> ${app.t('add_product')}
                            </button>
                        </div>
                    </div>
                ...
                <div id="product-modal" class="hidden fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
                    <div class="bg-slate-800 rounded-2xl w-full max-w-lg border border-slate-700 shadow-2xl overflow-hidden glass">
                        ...
                        <form id="product-form" onsubmit="app.handlers.saveProduct(event)" class="p-6 space-y-4">
                            ...
                            <div>
                                <label class="block text-sm text-slate-400 mb-1">${app.t('p_unit')}</label>
                                <select id="p-unit" class="w-full bg-slate-900 border border-slate-600 rounded p-2 text-white focus:border-indigo-500 focus:outline-none">
        ...
        renderReceiptPreview: (s) => {
            return `
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 10px; font-size: 12px;">
                    ...
                    <tbody>
                        <tr>
                            <td style="padding-top: 5px;">Cement Bag</td>
                            <td style="text-align: center; padding-top: 5px;">2</td>
                            <td style="text-align: right; padding-top: 5px;">4000.00</td>
                        </tr>
                        <tr>
                            <td>Hammer (Steel)</td>
    ...
    handlers: {
        ...
        handleLogoUpload: (input) => {
            ...
            reader.onload = (e) => {
                ...
                document.getElementById('st-logo').value = dataUrl;
                app.handlers.updateSettingsPreview();
            };
        ...
        saveProduct: async (e) => {
            ...
            const product = {
                ...
                stockCount: parseFloat(document.getElementById('p-stock').value),
            ...
            app.navigate('inventory'); // Refresh
            app.showToast(app.t('product_saved'));
        },

        deleteProduct: async (id) => {
            if (confirm(app.t('confirm_delete_product'))) {
        ...
        deleteSale: async (id) => {
            if (!confirm(app.t('confirm_delete_bill_msg', id))) return;
            ...
            if (sale.paymentMethod === 'credit' && sale.customerId) {
                ...
                if (customer) {
                    await db.customers.update(sale.customerId, {
                        creditBalance: Math.max(0, customer.creditBalance - sale.totalAmount)
                    });
                }
            }
        ...
        editSale: async (id) => {
            if (!confirm(app.t('confirm_edit_bill_msg', id))) return;

            const sale = await db.sales.get(id);
            if (!sale) return;

            // Perform Delete Logic (Restore Stock/Credit)
            // We duplicate logic here or call deleteSale (but deleteSale has confirm and refresh which we might want to avoid or modify)
            // Let's manually do it to avoid the second confirm and refresh issues
